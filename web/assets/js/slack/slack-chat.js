...
(function( $ ) {
	...
	var methods = {
		init: function (options) {
			this._defaults = {
        apiToken: 'xoxp-626474211910-624319058560-624358803125-460273d155366190963f66f15bb32870',		//#Slack token
        channelId: 'CJCPB0PS8',		//#Slack channel ID
        user: 'aanchalkhera.st',			//name of the user
        userLink: 'https://shailtechworkspace.slack.com/messages/DJE42QF3R/team/UJC9D1QGG/', 		//link to the user in the application - shown in #Slack
        userImg: 'https://secure.gravatar.com/avatar/ec6f6a99e24fa2da62b693e0744130c6.jpg?s=512&d=https%3A%2F%2Fa.slack-edge.com%2F00b63%2Fimg%2Favatars%2Fava_0024-512.png',		//image of the user
        userId: 'UJC9D1QGG',			//id of the user in the application
        defaultSysImg: '',			//image to show when the support team replies
	      defaultSysUser: '',
        queryInterval: 3000,
        chatBoxHeader: "Potrzebujesz pomocy? Skontaktujs się z nami już teraz!",
        slackColor: "#36a64f",
        messageFetchCount: 100,
        botUser: 'manpreet.st1129',		//username to post to #Slack
        sendOnEnter: true,
        disableIfAway: false,
        ...
        privateChannelId: false,
				isOpen: false,
				badgeElement: false,
				serverApiGateway: "/ajax/slack/server.php",
				useUserDetails: false,
				defaultInvitedUsers: [],
				defaultUserImg: '/assets/img/users/user-35.jpg',
	   	};
			...
			html += '<textarea class="form-control slack-new-message" type="text" placeholder="Zespół Kryptos72, pozostaje do Twojej dyspozycji..."></textarea>';
...
//console.log($this);
			...
			$('.slack-post-message').on('click', function () {
