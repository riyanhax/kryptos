...
(function (root, factory) {
  ...
  * ================================= */
  ...
  var Typeahead = function (element, options) {
    ...
    this.getItemHtml = this.options.getItemHtml || this.getItemHtml;
  ...
  Typeahead.prototype = {
    ...
    render: function (items) {
      ...
      items = $(items).map(function (i, item) {
        ...
        i.find('a').html(that.getItemHtml(item, that.highlighter(text)));
    ...
    displayText: function(item) {
      return 'name' in item ? item.name : item;
    },
   ...
   * =========================== */
    ...
    $.fn.typeahead = function (option) {
        ...
        if (typeof option == 'string' && option == 'getTypeahead') {
