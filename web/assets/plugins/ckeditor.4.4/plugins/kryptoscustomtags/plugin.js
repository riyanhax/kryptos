...
(function ($, CKEDITOR) {
        ...
        init: function (editor) {
            // Configure CKEditor DTD for custom custom-block element.
            ...
            dtd['custom-block'] = {'#': 1};
            dtd.$object['custom-block'] = 1;
            dtd.$cdata['custom-block'] = 1;
            dtd.$block['custom-block'] = 1;
            dtd.$nonEditable['custom-block'] = 1;
            for (tagName in dtd) {
                if (dtd.hasOwnProperty(tagName)) {
                    if (dtd[tagName].div) {
                        dtd[tagName]['custom-block'] = 1;
                    }
                }
            }
            ...
            editor.addCommand('editkryptoscustomtag', {
                allowedContent: 'custom-block[data-embed-button,data-entity-type,data-entity-uuid,data-entity-embed-display,data-entity-embed-settings,data-align,data-caption]',
                requiredContent: 'custom-block[data-embed-button,data-entity-type,data-entity-uuid,data-entity-embed-display,data-entity-embed-settings,data-align,data-caption]',
                modes: { wysiwyg : 1 },
                canUndo: true,
                exec: function (editor, data) {
                    ...
                    var saveCallback = function (values) {
                        var entityElement = editor.document.createElement('custom-block');
            ...
            editor.widgets.add('kryptoscustomtag', {
                ...
                allowedContent: 'custom-block[data-type]',
                requiredContent: 'custom-block[data-type]',
                ...
                upcast: function (element) {
                    ...
                    if (attributes['data-type'] === undefined) {
                        return;
                    }
            ...
            if (editor.ui.addButton) {
                ...
                for (var key in editor.config.DrupalEntity_buttons) {
                    ...
                    editor.ui.addButton(button.id, {
                        label: button.label,
                        data: button,
                        allowedContent: 'custom-block[!data-entity-type,!data-entity-uuid,!data-entity-embed-display,!data-entity-embed-settings,!data-align,!data-caption,!data-embed-button]',
            ...
            editor.ui.addRichCombo(button.id, {
                ...
                init: function() {
                    ...
                    for (i in pluginConfig.elements.blocks) {
                        if (pluginConfig.elements.blocks.hasOwnProperty(i)) {
                            ...
                            this.add(elementConfig.name, elementConfig.name, elementConfig.name);
                        }
                    }
                },
                onClick: function( value ) {
                    ...
                    $.ajax({
                        url: pluginConfig.elements.blocks[value].url,
                        success: function(result) {
                            var div = editor.document.createElement('custom-block', {
                                attributes: {
                                    'data-type': value,
