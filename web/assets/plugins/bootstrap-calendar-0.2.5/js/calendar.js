...
(function($) {
	...
	Calendar.prototype._render = function() {
		/*this.context.css({height: this.context.height()});*/
		this.context.html('');
		...
		var contextOldHeight = this.context.height();
		this.context.css('height', 'auto');
		var contextNewHeight = this.context.height();
		this.context.css('height', contextOldHeight);
		this.context.animate({height: contextNewHeight}, function () {
	...
	Calendar.prototype._update_month_year = function() {
		...
		var self = this;
		var activecell = 0;
		var downbox = $(document.createElement('div')).attr('id', 'cal-day-tick').html('<i class="glyphicon glyphicon-chevron-down"></i>');
