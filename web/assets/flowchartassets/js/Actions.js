...
Actions.prototype.init = function()
{
	...
	{
		var  diagramId = $("#diagram_id option:selected").val();
        var diagramName = $("#diagram_id option:selected").text();

        //Below comented code is for the graph's cell updation
        ...
        $.post("/registry-entries/diagramd", { id: diagramId },
            ...
            function (respond) {
               ...
               graph.removeCells(graph.getChildVertices(graph.getDefaultParent()));
                ...
                var doc = mxUtils.parseXml(respond);
				var codec = new mxCodec(doc);
				var elt = doc.documentElement;
                ui.editor.graph.model.beginUpdate();
                try {
         
                     ui.editor.setGraphXml(elt);
	...
	this.addAction('save', function() {
		...
		var val = mxUtils.getXml(ui.editor.getGraphXml());
		var  diagramId = $("#diagram_id option:selected").val();
