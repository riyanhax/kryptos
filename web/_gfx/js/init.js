...
var changeptype = function(){
    ...
    if(!$("#wrapper").hasClass("forced")){
        if(w > 990 && localStorage.getItem("menu_position") != 1){
        ...
        if($("#wrapper").hasClass("enlarged") && $("body").hasClass("fixed-left") && localStorage.getItem("menu_position") != 1){
...
$(document).ready(function(e){
    ...
    /*if(localStorage.getItem("menu_position") == 1) {
       collapseMenu(); 
    }*/
...
//TOOLTIP
    ...
    $(".open-left").click(function(e){
        if(localStorage.getItem("menu_position") == 1) {
            localStorage.setItem("menu_position", 0);
        } else {
            localStorage.setItem("menu_position", 1);
        }
    	collapseMenu(e);
    });
