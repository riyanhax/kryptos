...
class Application_Model_Zbiory extends Muzyka_DataModel {
    ...
    public function dodajZbior(array $data, array $uprawnienia) {
    ...
    public function save($data) {//, Zend_Db_Table_Row $pomieszczenia)
        ...
        if (!$zbiorIsGroup) {
            ...
            if (array_key_exists('zabezpieczenia', $data)) {
                $row->loadData(['safeguards', 'pomieszczenia', 'pomieszczenia.safeguards', 'pomieszczenia.safeguards_budynek']);
                ...
                $safeguardsInherited = array_merge($pomieszczeniaSafeguards, $budynkiSafeguards);
    ...
    public function edytujZbior($zbiory_id, array $data, array $uprawnienia) {
        try {
            $upow = Application_Service_Utilities::getModel('Upowaznienia');
            $last_nr = $upow->getLastNumber();
            $number_info = explode('/', $last_nr);
    ...
    public function getxmlGiodo($zbior_id, $organizacjaArr) {
        ...
        $data->loadData(['safeguards', 'pomieszczenia', 'pomieszczenia.safeguards', 'pomieszczenia.safeguards_budynek']);
        ...
        $safeguardsAll = array_merge($selfSafeguards, $pomieszczeniaSafeguards, $budynkiSafeguards);
