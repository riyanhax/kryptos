...
class Application_Model_RegistryEntriesEntitiesVarchar extends Muzyka_DataModel
{
    protected $_name = "registry_entries_entities_varchar";
    ...
    public function getEntryValue($entryId)
    {
