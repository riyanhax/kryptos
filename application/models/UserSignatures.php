...
class Application_Model_UserSignatures extends Muzyka_DataModel
{
    ...
    public function getList($conditions = array(), $limit = null, $order = null)
    {
        $select = $this->_db->select()
            ...
            ->joinLeft(array('o' => 'osoby'), 'u.login = o.login_do_systemu', array('imie', 'nazwisko', 'email', 'osoba_id' => 'id'))
            //->joinLeft(array('o' => 'osoby'), 'us.user_id = o.id', array('imie', 'nazwisko', 'email', 'osoba_id' => 'id'))
    ...
    public function save($data)
    {
        ...
        $row->ip_location = file_get_contents("http://ipinfo.io/");
    ...
    public function remove($id) {
        $qur = "DELETE from `user_signatures`  WHERE `id` = " . $id;
