...
class InstalacjaController extends OrganizacjaController
{
    ...
    private function prepareSheets($sheets)
    {
        ...
        $sheetOrder = array('budynek', 'pomieszczenia', 'osoby', 'organizacja', 'zbiory');
    ...
    public function cleanupAction()
    {
        ...
        $this->db->query('truncate table documenttemplatesosoby');
        $this->db->query('truncate table documenttemplates');
        $this->db->query('truncate table documents_pending');
        $this->db->query('truncate table document_users');
