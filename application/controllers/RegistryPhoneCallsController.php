...
class RegistryPhoneCallsController extends Muzyka_Admin
{
    ...
    protected $baseUrl = '/registry-phone-calls';
    ...
    public function reportAction()
    {
        ...
        foreach ($calls as $call) {
            $result[] = array(
                $call['date'],
                mb_strtoupper($this->destination_display[$call['direction']]['label']),
