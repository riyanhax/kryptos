...
class ZbioryController extends OrganizacjaController
{
    ...
    public function updateAction()
    {
        ...
        if ($id || $clone) {
            ...
            $zbiorObject->loadData(['safeguards', 'pomieszczenia', 'pomieszczenia.safeguards', 'pomieszczenia.safeguards_budynek',]);
            ...
            $this->view->safeguardsInherited = array_merge($pomieszczeniaSafeguards, $budynkiSafeguards);
            $this->view->safeguardsAll = array_merge($zbiorSafeguards, $pomieszczeniaSafeguards, $budynkiSafeguards);
        }
