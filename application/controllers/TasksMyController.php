...
class TasksMyController extends Muzyka_Admin
{
    ...
    public function detailsAction()
    {
        ...
        $userSigned = Application_Service_Utilities::getModel('UserSignatures')->getOne(['us.user_id = ?' => $storageTask['user_id'],'us.resource_id = ?' => $id]);
        ...
        switch ($task['type']) {
            ...
            case Application_Service_Tasks::TYPE_COURSE:
                ...
                break;
            case Application_Service_Tasks::TYPE_REGISTRY:
                $this->view->registry = $this->registryModel->findOne($task['object_id']);
                break;
        ...
        $this->view->userSigned = $userSigned;
